...
- Skip auto-inject when OpenDir is already active on the page.
- The loader guards against duplicate injection within the same document load.
...
- name: OpenDir, author: David W. Bryson, version: 0.1.8
